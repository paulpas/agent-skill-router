...
- [Primary Documentation](https://cloud.google.com/compute/docs/instances/creating-instance-with-gcloud)
- [API Reference or Getting Started](https://cloud.google.com/compute/docs/images)
- [Configuration Guide](https://cloud.google.com/compute/docs/disks)
- [Best Practices](https://cloud.google.com/compute/docs/instances/connecting-to-instance)
- [Common Patterns or Tutorials](https://cloud.google.com/compute/docs/instances/monitoring-managing)
