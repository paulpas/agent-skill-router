...
- [Primary Documentation](https://cloud.google.com/deployment-manager/docs/create-resources)
- [API Reference or Getting Started](https://cloud.google.com/deployment-manager/docs/templates/tutorials-templates-overview)
- [Configuration Guide](https://cloud.google.com/deployment-manager/docs/templates/action-type-dependencies)
- [Best Practices](https://cloud.google.com/deployment-manager/docs/templates/using-properties-in-configuration-files)
- [Common Patterns or Tutorials](https://cloud.google.com/deployment-manager/docs/references)
