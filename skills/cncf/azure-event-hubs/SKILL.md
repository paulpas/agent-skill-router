...
- [Primary Documentation](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-create)
- [API Reference or Getting Started](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-about)
- [Configuration Guide](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-capture-overview)
- [Best Practices](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-scale-units)
- [Common Patterns or Tutorials](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-partitions)
