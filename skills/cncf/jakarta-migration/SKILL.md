...
metadata:
  version: "1.0.0"
  domain: cncf
  triggers: java ee migration, javax to jakarta, java ee to jakarta ee, namespace change, jakartaee-api, javax.servlet, javax.persistence, migration tool change
  archetypes:
  - tactical
  anti_triggers:
  - brainstorming
