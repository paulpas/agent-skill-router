...
- [Primary Documentation](https://cloud.google.com/secret-manager/docs/create-manage-secrets)
- [API Reference or Getting Started](https://cloud.google.com/secret-manager/docs/accessing-a-secret)
- [Configuration Guide](https://cloud.google.com/secret-manager/docs/deleting-a-secret)
- [Best Practices](https://cloud.google.com/secret-manager/docs/rotating-secrets)
- [Common Patterns or Tutorials](https://cloud.google.com/secret-manager/docs/secret-manager-overview)
