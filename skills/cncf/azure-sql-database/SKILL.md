...
- [Primary Documentation](https://learn.microsoft.com/en-us/azure/azure-sql/database/single-database-create-quickstart)
- [API Reference or Getting Started](https://learn.microsoft.com/en-us/azure/azure-sql/database/security-overview)
- [Configuration Guide](https://learn.microsoft.com/en-us/azure/azure-sql/database/performance-guidelines-best-practices)
- [Best Practices](https://learn.microsoft.com/en-us/azure/azure-sql/database/auto-tuning)
- [Common Patterns or Tutorials](https://learn.microsoft.com/en-us/azure/azure-sql/database/pause-resume-database-automatically)
