...
- [Primary Documentation](https://cloud.google.com/dns/docs/overview)
- [API Reference or Getting Started](https://cloud.google.com/dns/docs/record-set-action)
- [Configuration Guide](https://cloud.google.com/dns/docs/zones)
- [Best Practices](https://cloud.google.com/dns/docs/configure-forwarding-zones)
- [Common Patterns or Tutorials](https://cloud.google.com/dns/docs/health-checks)
