...
- [Primary Documentation](https://cloud.google.com/load-balancing/docs/intro-overview-of-lb)
- [API Reference or Getting Started](https://cloud.google.com/load-balancing/docs/https/create-external-managed-proxy-configuration-http)
- [Configuration Guide](https://cloud.google.com/load-balancing/docs/tcp/create-internal-managed-proxy-configuration-tcp)
- [Best Practices](https://cloud.google.com/load-balancing/docs/https/setup-external-managed-proxy-ssl)
- [Common Patterns or Tutorials](https://cloud.google.com/load-balancing/docs/https/adding-certs-lb-https)
