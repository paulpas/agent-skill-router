...
- [Primary Documentation](https://cloud.google.com/monitoring/docs/resource-types)
- [API Reference or Getting Started](https://cloud.google.com/monitoring/docs/alerting/create-alerts)
- [Configuration Guide](https://cloud.google.com/monitoring/docs/uptime-checks)
- [Best Practices](https://cloud.google.com/monitoring/docs/metrics)
- [Common Patterns or Tutorials](https://cloud.google.com/monitoring/docs/prometheus-quickstart)
