...
- [Primary Documentation](https://learn.microsoft.com/en-us/azure/traffic-manager/traffic-manager-overview)
- [API Reference or Getting Started](https://learn.microsoft.com/en-us/azure/traffic-manager/traffic-manager-endpoint-types)
- [Configuration Guide](https://learn.microsoft.com/en-us/azure/traffic-manager/traffic-manager-monitoring)
- [Best Practices](https://learn.microsoft.com/en-us/azure/traffic-manager/traffic-manager-configure-dns)
- [Common Patterns or Tutorials](https://learn.microsoft.com/en-us/azure/traffic-manager/traffic-manager-probe-port)
