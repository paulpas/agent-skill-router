...
- [Primary Documentation](https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-overview)
- [API Reference or Getting Started](https://learn.microsoft.com/en-us/azure/load-balancer/tutorial-load-balancer-standard-portal)
- [Configuration Guide](https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-outbound-rules)
- [Best Practices](https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-multivnet-cross-tenant-lb)
- [Common Patterns or Tutorials](https://learn.microsoft.com/en-us/azure/load-balancer/load-balancer-tcp-rules)
