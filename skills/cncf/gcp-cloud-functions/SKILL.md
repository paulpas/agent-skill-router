...
- [Primary Documentation](https://cloud.google.com/functions/docs/create-function)
- [API Reference or Getting Started](https://cloud.google.com/functions/docs/concepts/executables)
- [Configuration Guide](https://cloud.google.com/functions/docs/security-authentication)
- [Best Practices](https://cloud.google.com/functions/docs/networking)
- [Common Patterns or Tutorials](https://cloud.google.com/functions/docs/securing/iam)
