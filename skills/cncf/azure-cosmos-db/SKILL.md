...
- [Primary Documentation](https://learn.microsoft.com/en-us/azure/cosmos-db/create-cosmos-db-resources-portal)
- [API Reference or Getting Started](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/query)
- [Configuration Guide](https://learn.microsoft.com/en-us/azure/cosmos-db/security-security)
- [Best Practices](https://learn.microsoft.com/en-us/azure/cosmos-db/performance-tips)
- [Common Patterns or Tutorials](https://learn.microsoft.com/en-us/azure/cosmos-db/distributed-data-bases)
