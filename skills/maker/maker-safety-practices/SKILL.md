...
description: Implements makerspace safety protocols with PPE selection by hazard type, machine-specific safe operating procedures (3D printers, laser cutters, CNC, soldering), and emergency response.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: maker
  triggers: maker safety, makerspace safety, 3d printer safety, laser cutter safety, PPE selection, fume extraction, how do i work safely with tools
  role: implementation
