...
metadata:
  version: "1.0.0"
  domain: linux
  triggers: bash parameter expansion, ${VAR:-default}, variable default value, shell variable substitution, pattern matching shell, case modification, how do i handle unset variables, bash safe defaults variable substitution
  archetypes:
  - tactical
  anti_triggers:
  - brainstorming
