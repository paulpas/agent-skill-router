---
name: systemd-boot
description: Analyzes and optimizes the systemd boot process including target management, boot time profiling with systemd-analyze, initramfs configuration, and custom boot-time unit creation for Linux systems.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: linux
  triggers: systemd boot, boot time optimization, systemd-analyze, target management, how do i speed up boot, dracut initramfs, rescue mode, boot logging
  role: implementation
