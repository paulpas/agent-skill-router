...
description: Manages Linux background processes, parallel execution, and job control using &, jobs, fg, bg, wait, xargs -P, and GNU parallel for shell scripting.
license: MIT
...
metadata:
  ...
  triggers: shell background processes, parallel execution, job control, fg bg jobs wait, xargs P flag, background shell, process management
