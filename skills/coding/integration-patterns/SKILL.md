...
description: Implements service-to-service integration patterns (adapter, API gateway, saga, circuit breaker, event-driven) for connecting distributed systems and legacy services with resilience.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: integration patterns, service integration, adapter pattern, saga pattern, circuit breaker, API gateway, messaging, event-driven, system communication, how do i connect systems
  role: implementation
  scope: implementation
  output-format: code
  content-types: [code, guidance, examples, config, do-dont]
  related-skills: anti-corruption-layer, event-driven-patterns, rest-api-patterns, microservice-resilience-patterns
---
