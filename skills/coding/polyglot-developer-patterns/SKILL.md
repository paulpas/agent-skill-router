...
metadata:
  version: "1.0.0"
  domain: coding
  triggers: polyglot developer, multi-language productivity, learn new language, code review in different language, language translation, context switching between languages, programming language learning, how do i become proficient in multiple languages review in different language
  archetypes:
  - tactical
  - generation
  anti_triggers:
