...
metadata:
  version: "1.0.0"
  domain: coding
  triggers: code duplication, duplicate code detection, copy-paste code, boilerplate removal, semantic duplication, radon metrics, pylint warnings, refactoring detection removal
  archetypes:
  - educational
  anti_triggers:
  - brainstorming
