---
name: bigquery-sdk
description: Integrates Google BigQuery using google-cloud-bigquery 3.x with patterns for SQL queries, dataset/table management, streaming inserts, BI Engine, and load jobs from GCS.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: bigquery, google cloud bigquery, bigquery sql, how do i query bigquery from python, bigquery streaming, google-cloud-bigquery, bi engine, bigquery load job
  role: implementation
