---
name: openai-api
description: Integrates OpenAI API (GPT-5, Responses API, Embeddings, DALL-E 3, Whisper, Realtime) using the openai Python SDK v2.38+ with proper error handling and async patterns.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: openai, gpt-5, responses api, chat completions, function calling, openai embeddings, how do i use the openai api, text-embedding-3-large
  role: implementation
