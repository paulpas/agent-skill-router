---
name: perplexity-api
description: Integrates Perplexity AI API (Sonar chat completions, online search, multi-step queries) using the perplexity-openai Python SDK for real-time web-connected LLM responses.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: perplexity, perplexity ai, sonar, perplexity api, perplexity sonar, online LLM, how do i use perplexity, real-time search LLM
  role: implementation
