...
description: Implements language selection heuristics, polyglot monorepo patterns, and cross-language communication protocols for multi-language software systems.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: polyglot, multi-language, language selection, go vs typescript, rust vs python, monorepo build, cross-language communication, protocol buffer, interop patterns, which language to use
  role: implementation
