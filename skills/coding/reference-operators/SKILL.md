...
description: Implements reference (&) and address-of operators across C++, Rust, C#, and PHP for safe memory access, parameter passing, and pointer arithmetic.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: reference operator, address of, pass by reference, & operator, pointer, dangling reference, borrowed reference, mutable reference, C++ references, Rust lifetimes, PHP references, C# ref out, memory safety, rvalue reference
  role: implementation
