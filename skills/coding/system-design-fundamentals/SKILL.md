...
description: Implements production system design patterns including capacity planning, multi-tier caching strategies, load balancing algorithms, rate limiting, CDN placement decisions, database sharding strategies, and circuit breaker implementations for scalable distributed applications.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: system design, capacity planning, cache strategy, load balancing, rate limiting, CDN placement, database sharding, circuit breaker, how do i design a scalable system, request estimation, traffic scaling, horizontal scaling
  role: implementation
