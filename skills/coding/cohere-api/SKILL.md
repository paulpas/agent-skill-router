---
name: cohere-api
description: Integrates Cohere API (Generate, Embed, Rerank, Classify, Chat, Tool Use) using the cohere Python SDK for NLP, search, and RAG applications.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: cohere, cohere api, cohere embed, cohere rerank, cohere generate, cohere chat, how do i use cohere, cohere classify
  role: implementation
