...
description: Enforces deterministic structured output generation (JSON schemas, markdown tables, templated responses) for reliable downstream processing in AI agent workflows.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: output formatting, structured output, json schema, response templating, deterministic output, data validation, prompt engineering
  role: implementation
