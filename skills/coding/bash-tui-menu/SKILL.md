---
name: bash-tui-menu
description: Implements robust interactive Bash TUI menus with dialog widgets, safe selection handling, cancel paths, and non-interactive fallbacks.
license: MIT
...
metadata:
  ...
  triggers: bash tui menu, dialog command, interactive shell script, terminal menu, checklist radiolist, how do i make bash menus, ncurses dialog
  related-skills: shell-parameter-expansion, shell-command-chaining, shell-process-management, output-formatting
---
