...
description: Designs relational database schemas with proper normalization, indexing strategies, versioned migrations, and constraint enforcement for scalable application backends.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: database design, schema design, data modeling, sql migrations, indexing strategy, database normalization, foreign keys, entity relationship
  role: implementation
