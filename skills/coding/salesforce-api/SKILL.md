---
name: salesforce-api
description: Implements Salesforce API integration (REST, SOQL, Bulk API, Apex, using simple-salesforce Python SDK with record CRUD operations, SOQL queries, Bulk API for large datasets, Apex calls, and Salesforce REST API patterns.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: salesforce, soql, salesforce api, simple salesforce, salesforce objects, salesforce bulk api, how do i integrate with salesforce, crm integration
  role: implementation
