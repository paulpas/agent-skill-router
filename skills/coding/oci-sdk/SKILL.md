---
name: oci-sdk
description: Integrates Oracle Cloud Infrastructure services (Compute, Object Storage, Autonomous DB, Functions) using the OCI Python SDK with config-based authentication and resource management.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: oracle cloud, oci sdk, oci python, oracle cloud infrastructure, autonomous database, object storage, how do i use oci from python
  role: implementation
