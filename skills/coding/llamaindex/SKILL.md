---
name: llamaindex
description: Integrates LlamaIndex (indexes, query engines, agents, workflows, document parsing, RAG pipelines) for building data-aware LLM applications in Python.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: llamaindex, llama index, rag pipeline, query engine, vector store index, llama parse, how do i use llamaindex, document agents
  role: implementation
