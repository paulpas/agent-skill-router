...
description: Evaluates competing engineering options using weighted decision matrices, reversibility analysis, and multi-criteria tradeoff frameworks to make defensible technical decisions under constraints.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: engineering tradeoffs, decision making under constraints, build vs buy, speed vs quality, technology selection, weighted decision matrix, tradeoff analysis, two-way door decisions, CAP theorem software
  role: orchestration
  scope: orchestration
  output-format: analysis
  content-types: [guidance, examples, do-dont, diagrams]
  related-skills: architecture-decision-records, design-pattern-selection, engineering-principles, technical-debt-management
---
