...
description: Normalizes and standardizes inconsistent inbound data into uniform internal formats using typed normalizers, locale-aware converters, and deterministic transformation pipelines for reliable downstream processing.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: input normalization, data standardization, date parsing, currency conversion, phone number format, address normalization, text normalization, how do i normalize data, data cleaning, convert formats
  role: implementation
