...
metadata:
  version: "1.0.0"
  domain: coding
  triggers: incident response, production outage, on-call procedures, postmortem, blameless postmortem, RCA root cause analysis, service degradation, how do i handle a production incident blameless postmortem
  archetypes:
  - tactical
  - generation
  anti_triggers:
