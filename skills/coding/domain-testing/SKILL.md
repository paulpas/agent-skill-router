---
name: domain-testing
description: Verifies DDD domain model correctness through invariant testing of aggregates and value objects, specification candidate tests, test double strategies, and domain event publishing assertions.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: domain testing, aggregate testing, value object tests, specification patterns, ddd unit tests, invariant verification, how do i test domain models, domain layer testing
  role: implementation
