---
name: weaviate-api
description: Integrates Weaviate vector database (v4 Python client, collections, vector search, hybrid, generative modules, GraphQL) for AI-powered search applications.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: weaviate, vector database, weaviate client, hybrid search, generative search, weaviate graphql, how do i use weaviate, vector collections
  role: implementation
