...
metadata:
  version: "1.0.0"
  domain: coding
  triggers: braintree, braintree transactions, braintree vault, braintree subscriptions, braintree marketplace, 3d secure, braintree webhooks, how do i integrate braintree payments braintree marketplace
  archetypes:
  - tactical
  - generation
  anti_triggers:
