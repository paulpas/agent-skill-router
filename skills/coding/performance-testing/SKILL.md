...
description: Measures application throughput, latency percentiles, and resource utilization under realistic load to identify bottlenecks before they reach production.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: performance testing, load testing, stress test, p95 latency, bottleneck detection, how do i measure system performance, k6, locust
  role: implementation
