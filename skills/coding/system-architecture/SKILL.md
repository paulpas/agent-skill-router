...
metadata:
  version: "1.0.0"
  domain: coding
  triggers: system architecture, software design, hexagonal architecture, ports and adapters, layered architecture, dependency injection, architectural boundaries, event-driven adapters
  archetypes:
  - tactical
  - generation
  anti_triggers:
