---
name: design-systems
description: Implements production design systems with design token architecture, component theming, accessibility standards, documentation patterns, and cross-platform consistency for scalable UI ecosystems.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: design system, design tokens, theming, accessibility, a11y, component library, UI kit, design language, style guide, token architecture, cross-platform consistency
  role: implementation
