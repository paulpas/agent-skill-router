---
name: aws-bedrock
description: Integrates AWS Bedrock (Claude, Llama, Titan, Nova, Converse API, Knowledge Bases, Agents) using Boto3 with cross-model patterns and IAM auth.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: aws bedrock, boto3 bedrock, amazon nova, converse api, bedrock knowledge base, bedrock agent, how do i use bedrock, invoke model bedrock
  role: implementation
