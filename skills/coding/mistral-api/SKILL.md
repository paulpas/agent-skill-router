---
name: mistral-api
description: Integrates Mistral AI API (Chat, Embeddings, Function Calling, Codestral, Agents) using the mistralai Python SDK for LLM and code generation applications.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: mistral, mistral ai, mistral api, codestral, mistral chat, mistral embeddings, how do i use mistral, le chat
  role: implementation
