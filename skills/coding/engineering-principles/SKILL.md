...
description: Enforces core software engineering principles (SOLID, DRY, KISS, separation of concerns) to produce clean, maintainable, and scalable code architecture.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: engineering principles, SOLID, DRY, KISS, separation of concerns, code architecture, defensive programming, clean code
  role: implementation
