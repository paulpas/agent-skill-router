...
description: "Implements CI/CD pipelines with build automation, test orchestration, blue-green/canary deployments, artifact management, and environment promotion for reliable software delivery."
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: coding
  triggers: CI/CD pipeline, continuous integration, continuous deployment, deployment strategy, blue-green deployment, canary release, how do i set up CI/CD
  role: implementation
