...
description: Builds and debugs automated workflows in Make (Integromat) using modules, scenarios, routing, error handling, and scheduling for no-code/low-code automation.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: agent
  triggers: make, make com, integromat, workflow automation, no code automation, scenario builder, webhook trigger, task routing
  role: orchestration
  scope: orchestration
