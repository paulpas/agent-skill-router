...
description: Designs personalized development workflows by mapping task types to optimized process patterns, enabling developers to choose structured approaches that match project complexity and team size.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: agent
  triggers: personal workflow, developer workflow, structured approach, task methodology, how do i organize my work, development process, workflow customization, project methodology
  role: orchestration
  scope: orchestration
