...
description: Curates and maintains a personal library of validated code patterns, solutions, and anti-patterns accumulated through development experience, enabling faster problem-solving on future tasks.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: agent
  triggers: pattern library, developer patterns, reusable solutions, personal knowledge base, code patterns, anti-patterns, how do i organize my code snippets, solution catalog
  role: reference
  scope: orchestration
