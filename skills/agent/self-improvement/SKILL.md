...
description: Enables AI agents to continuously improve through structured reflection cycles, feedback-driven strategy evolution, pattern recognition across experiences, and adaptive knowledge base management.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: agent
  triggers: self improvement, agent reflection, feedback loop, strategy evolution, continuous improvement, how do i improve ai agent, experience-based learning, agent optimization
  role: implementation
