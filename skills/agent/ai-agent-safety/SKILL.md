...
description: Implements guardrails, safety checks, hallucination detection, prompt injection defense, and output validation for autonomous AI agents to prevent misuse, unauthorized actions, and unreliable behavior.
license: MIT
compatibility: opencode
metadata:
  version: "1.0.0"
  domain: agent
  triggers: ai agent safety, hallucination detection, prompt injection, output validation, tool call safety, guardrails, autonomous agent safety, AI safety
  role: implementation
