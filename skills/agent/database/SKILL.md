...
- examples
- do-dont
description: Implements intelligent database with multi-factor skill selection, fallback
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: database, database, how do i database, orchestrate database, automate
