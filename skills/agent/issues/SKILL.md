...
- examples
- do-dont
description: Implements intelligent issues with multi-factor skill selection, fallback
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: issues, issues, how do i issues, orchestrate issues, automate issues,
    agent issues
  archetypes:
  - orchestration
  - strategic
