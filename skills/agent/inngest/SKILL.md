...
- examples
- do-dont
description: Implements intelligent inngest with multi-factor skill selection, fallback
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: inngest, inngest, how do i inngest, orchestrate inngest, automate inngest,
    agent inngest
  archetypes:
  - orchestration
  - strategic
