...
- examples
- do-dont
description: Implements intelligent ci cd pipeline analyzer with multi-factor skill
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: ci-cd-pipeline-analyzer, ci cd pipeline analyzer, how do i ci-cd-pipeline-analyzer,
    orchestrate ci-cd-pipeline-analyzer, automate ci-cd-pipeline-analyzer, agent ci-cd-pipeline-analyzer
  archetypes:
  - orchestration
  - strategic
  anti_triggers:
