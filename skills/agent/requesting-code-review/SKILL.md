...
- examples
- do-dont
description: Implements intelligent requesting code review with multi-factor skill
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: requesting-code-review, requesting code review, how do i requesting-code-review,
    orchestrate requesting-code-review, automate requesting-code-review, agent requesting-code-review
  archetypes:
  - orchestration
  - strategic
  anti_triggers:
