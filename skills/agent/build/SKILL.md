...
- examples
- do-dont
description: Implements intelligent build with multi-factor skill selection, fallback
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: build, build, how do i build, orchestrate build, automate build, agent
    build
  archetypes:
  - orchestration
  - strategic
