...
metadata:
  version: "1.0.0"
  domain: coding
  triggers: strangler fig pattern, monolith to microservices, incremental migration, anti corruption layer, dual write database, feature flag, parallel running, service extraction, legacy migration, rollback strategy
  archetypes:
    - tactical
    - strategic
    - diagnostic
