...
declare \
  ...
  RETRIEVAL_TRIGGER_MATCH_WEIGHT \
  RETRIEVAL_ARCHETYPE_WEIGHT \
  RETRIEVAL_HISTORICAL_WEIGHT \
  MMR_LAMBDA
...
run_installation() {
  ...
  ENV_ARGS+=(-e "LINK_FOLLOWING_ENABLED=${LINK_FOLLOWING_ENABLED:-true}")
  ENV_ARGS+=(-e "ALLOW_EXTERNAL_LINKS=${ALLOW_EXTERNAL_LINKS:-true}")
  ENV_ARGS+=(-e "MAX_LINK_DEPTH=${MAX_LINK_DEPTH:-2}")
  ENV_ARGS+=(-e "MAX_EXTERNAL_SIZE_KB=${MAX_EXTERNAL_SIZE_KB:-8192}")
  ENV_ARGS+=(-e "EXTERNAL_COMPRESSION_MODE=${EXTERNAL_COMPRESSION_MODE:-semantic}")
  ENV_ARGS+=(-e "JS_RENDERING_ENABLED=${JS_RENDERING_ENABLED:-true}")
  ...
  [[ -n "${RETRIEVAL_BM25_WEIGHT:-}" ]]          && ENV_ARGS+=(-e "RETRIEVAL_BM25_WEIGHT=$RETRIEVAL_BM25_WEIGHT")
  [[ -n "${RETRIEVAL_TRIGGER_MATCH_WEIGHT:-}" ]]  && ENV_ARGS+=(-e "RETRIEVAL_TRIGGER_MATCH_WEIGHT=$RETRIEVAL_TRIGGER_MATCH_WEIGHT")
